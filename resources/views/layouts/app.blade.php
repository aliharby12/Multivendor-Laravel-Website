...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-white bg-dark shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="/">
                <img class="log" src="/img/logo.png" alt="" style="height: 50px">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item ml-5">
                        <a class="nav-link" href="{{ route('shop.create') }}">become a vendor</a>
                    </li>
                </ul>
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; aliharby565@gmail.com 2020</p>
    </div>
    <!-- /.container -->
  </footer>
